...
**Version:** 0.3.3 (Released November 7, 2025)
...
- 🧰 `mcporter generate-cli` now supports `--bundler rolldown|bun` with automatic Bun bundling when the runtime resolves to Bun.
